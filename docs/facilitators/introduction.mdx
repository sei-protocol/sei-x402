...
<CardGroup cols={2}>
  <Card title="Verify Payments" icon="shield-check">
  ...
  <Card title="Provide Responses" icon="reply">
  ...
  <Card title="Protocol Compliance" icon="check-circle">
...
<AccordionGroup>
  <Accordion title="Reduced Operational Complexity" icon="gear">
...
<Accordion title="Protocol Consistency" icon="sync">
...
<CardGroup cols={2}>
  <Card title="Set Up Your Own" href="/facilitators/setup" icon="server">
    **Self-hosted Facilitator** Complete setup guide for running your own
    facilitator instance
  </Card>
  <Card title="Use Express.js" href="/facilitators/express" icon="code">
